...
export const ConstructionIcon: React.FC<Props> = ({ size }) => {
  return (
    <svg
    ...
    >
      <path
        fill="#d8d9dc"
        d="M3.5,19v2.68H5.64a10.576,10.576,0,0,0,1.14,2.75L5.27,25.94l3.79,3.79,1.51-1.51a10.575,10.575,0,0,0,2.75,1.14V31.5h5.36V29.36a10.575,10.575,0,0,0,2.75-1.14l1.51,1.51,3.79-3.79-1.51-1.51a10.576,10.576,0,0,0,1.14-2.75H28.5V19Zm7.09,1H21.41a5.5,5.5,0,0,1-10.82,0Z"
      />
      <path
        fill="#ffdd56"
        d="M16,2.5h0A13.5,13.5,0,0,1,29.5,16v.5a0,0,0,0,1,0,0H2.5a0,0,0,0,1,0,0V16A13.5,13.5,0,0,1,16,2.5Z"
      />
      <rect
        width="31"
        height="3"
